      ...
      const newForm = `
                      ...
                      <div class="row col-md-10 mb-9">
                          ...
                          <div class="col-md-6 mb-4">
                              ...
                              <select name="order_details[${index}][service_type]" class="form-control" required>
                                  <option value="Прибирання будівельного сміття">Прибирання будівельного сміття</option>
                                  <option value="Перевезення великогабаритних об'єктів">Перевезення великогабаритних об'єктів</option>
                                  <option value="Розвантаження-завантаження">Розвантаження-завантаження</option>
                              </select>
                          </div>   
                      </div>
                      <div class="row col-md-10 mb-9">
                      ...
                      <div class="col-md-6 mb-4">
                          <select name="order_details[${index}][street]" class="form-control" required>
                              ...
                              <option value="Вулиця 2">Вулиця 2</option>
                              <option value="Вулиця 3">Вулиця 3</option>
                              <option value="Вулиця 4">Вулиця 4</option>
                          </select>
                      </div>   
                  </div>
                  ...
                  <div class="row col-md-10 mb-9">
                      ...
                      <div class="col-md-6 mb-4">
                          <select name="order_details[${index}][house]" class="form-control" required>
                              <option value="34а">34а</option>
                              <option value="56б">56б</option>
                              <option value="23г">23г</option>
