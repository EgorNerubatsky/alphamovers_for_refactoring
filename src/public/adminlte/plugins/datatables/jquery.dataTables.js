...
(function( $, window, document, undefined ) {
	 ...
	 *      articles
	 *  @returns {object} out Article, just for convenience - out === the return.
	 *  @memberof DataTable#oApi
	...
	//
	// Backwards compatibility. Alias to pre 1.10 Hungarian notation counter modules
	//
	$.extend( _ext, {
	...
	/**
	 * Article to internal functions for use by plug-in developers. Note that
	 * these methods are articles to internal functions and are considered to be
