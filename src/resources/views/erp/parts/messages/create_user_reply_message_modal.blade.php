<div class="modal fade bd-example-modal-sm" id="myModal{{ $message->id }}" tabindex="-1" role="dialog"
    ...
    <div class="modal-content-my">
        ...
        <div class="modal-body">
            ...
            <form id="taskForm" class="mt-4"
                  action="{{ route($roleData['roleData']['messages_message_reply'], ['id'=> $message->id]) }}"
