            ...
            <div class="card">
                ...
                <div class="card-body">
                                ...
                                @if(!empty($file->path))
                                    ...
                                    <div class="col-lg-8">
                                        @if(in_array($extension, ['pdf','doc', 'docx']))
                                            <a href="{{ asset($file->path) }}" target="_blank" class="btn mb-1 btn-rounded btn-warning">
                                                <span class="btn-icon-left">
                                                    <i class="fas fa-eye"></i>
                                                </span>Переглянути резюме
                                            </a>

                                            <a href="#" data-toggle="modal" data-target="#confirmationModal" data-delete-url="{{ route($roleData['roleData']['employee_delete_file'], ['id'=> $file->getKey()]) }}" title="Delete" class="btn btn-danger btn-rounded btn-sm">
                                                <span >
                                                    <i class="fas fa-trash"></i>
                                                </span>
                                            </a>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6">
                            <input id="middle_name" name="middle_name" class="form-control" value="{{ $employee->middle_name }}"
