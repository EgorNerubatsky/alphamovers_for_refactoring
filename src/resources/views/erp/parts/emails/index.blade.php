            ...
            <div class="card">
                <div class="card-body">
                    <div class="card-header">
                        <h3 class="card-title"><b>Вхiднi листи</b></h3>
                        <div class="card-tools">
                            <form action="{{ route($roleData['roleData']['emails_search']) }}" method="GET">
                                <div class="input-group">
                                    ...
                                    <input type="hidden" name="search_type" value="inbox_emails">
                                    <div class="append">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="icheck-primary">
                                                ...
                                                <input type="checkbox" id="selected_emails[]" name="selected_emails[]"
                                                       value="{{$mail->id}}">
                                            </div>
                                        </td>
                                        @if(!$mail->read)
